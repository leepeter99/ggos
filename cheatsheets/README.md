...
# Cheatsheets Index (GGOS)
These documents cover both general usage and the specific configuration as defined in the NixOS configuration "GGOS".

- General use: Practical, task-focused tips and top workflows.
- GGOS specifics: Notes reflecting how tools are configured in this repository (modules/home/*) so behavior matches your system.
...
- Refer to tool-specific cheatsheets for day-to-day commands, then cross-check any GGOS-specific settings.
...
## 🛠️ Notes
- Ghostty cheatsheet reflects bindings from modules/home/terminals/ghostty.nix (GGOS).
