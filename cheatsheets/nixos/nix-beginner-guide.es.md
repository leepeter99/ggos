# ¡Bienvenido a GGOS! Guía para principiantes

¡Bienvenido! Esta guía es para usuarios nuevos en Nix que quieren realizar personalizaciones comunes en GGOS. Mantendremos todo simple y al grano.
...
- `modules/`: configuración modular reutilizable.
  - `modules/core/global-packages.nix`: paquetes para todos tus equipos GGOS.
