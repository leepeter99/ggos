...
This guide gives **basic steps** and **which files to edit** to add GNOME to GGOS.
...
Once you have the file created. In the GGOS directory run `git add . ` then `zcli rebuild`
