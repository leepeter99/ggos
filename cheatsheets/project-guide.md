...
- Repo location is expected at ~/ggos. If you place it elsewhere, update modules/core/nh.nix (programs.nh.flake) to the new path.
...
- modules/core
  ...
  - nh.nix enables nh, configures GC, and pins programs.nh.flake = /home/${username}/ggos
- modules/drivers
...
- If the repo is not under ~/ggos, update modules/core/nh.nix so zcli/nh operate on the correct path
