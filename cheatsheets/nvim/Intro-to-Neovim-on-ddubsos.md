# Intro to Neovim on GGOS

Welcome! This cheatsheet introduces Neovim as configured in GGOS (modules/home/nvf.nix). It focuses on beginner tasks and the key plugins and keymaps in this setup.
