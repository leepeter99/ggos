# Introducción a Neovim en GGOS

¡Bienvenido! Esta chuleta introduce Neovim tal y como está configurado en GGOS (modules/home/nvf.nix). Se centra en tareas para principiantes y los plugins/atajos clave de este setup.
