# How to theme or add Waybars in GGOS

This guide shows how GGOS selects and configures Waybar, how to add your own Waybar module, and how to customize fonts, sizes, colors, icons, widgets, and layout. It also calls out where to put scripts and a critical note about git add to avoid rebuild failures.
...
```nix path=/home/dwilliams/GGOS/hosts/default/variables.nix start=73
  # Set Waybar
...
```nix path=/home/dwilliams/GGOS/modules/home/waybar/waybar-tony.nix start=15
...
```nix path=/home/dwilliams/GGOS/hosts/default/variables.nix start=81
  #waybarChoice = ../../modules/home/waybar/waybar-ddubs.nix;
  waybarChoice = ../../modules/home/waybar/waybar-tony.nix;
  #waybarChoice = ../../modules/home/waybar/waybar-ddubs-2.nix;
```
...
```
5) Rebuild as you normally do for GGOS.
...
- In waybar-tony.nix:
```css path=/home/dwilliams/GGOS/modules/home/waybar/waybar-tony.nix start=207
* {
...
```nix path=/home/dwilliams/GGOS/modules/home/waybar/waybar-simple.nix start=28
...
```css path=/home/dwilliams/GGOS/modules/home/waybar/waybar-tony.nix start=218
#workspaces button {
    padding: 0 6px;
    color: @cyn;
...
```nix path=/home/dwilliams/GGOS/modules/home/waybar/waybar-ddubs.nix start=104
"pulseaudio" = {
...
7) Known Waybar modules you’ll see in GGOS configs
...
```nix path=/home/dwilliams/GGOS/modules/home/waybar/waybar-ddubs.nix start=14
