{
  ...
  gitUsername = "leepeter99";
  gitEmail = "leepeterwy@gmail.com";
  ...
  tmuxEnable = true;
  herdrEnable = true; # Agent multiplexer (tmux-like), https://herdr.dev
  ...
  extraMonitorSettings = "
    monitor=DP-1,2560x1440@59.95,1440x412,1.0
