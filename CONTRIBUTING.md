...
We're excited that you're interested in contributing to GGOS! Your help is
essential for keeping it great.

This document is a guide to help you through the process of contributing to
GGOS. We are a welcoming and friendly community, and we are happy to help you
get started.
...
There are many ways to contribute to GGOS, from writing code to reporting
...
- Your environment details (OS, GGOS version, etc.).
...
- A detailed description of the enhancement, including the problem it solves and
  why it would be a good addition to GGOS.
- Any relevant mockups or screenshots.

### 💻 Code Contributions

If you want to contribute code to GGOS, please follow these steps:
...
5. **Open a pull request** to the `main` branch of the GGOS repository.
...
- **Twitter:** [@GGOS](https://twitter.com/GGOS)

We are happy to help you get started with contributing to GGOS. We look
