...
## GGOS 🟰 Best ❄️ NixOS Configs

\*\* Updated: January 16th, 2026

GGOS is a simple way of reproducing my configuration on any NixOS system.
...
- The `ggos` folder (this repo) is expected to be in your home directory.
...
- The entire idea of GGOS is to make NixOS an approachable space.
...
> ONLY**. If you already have GGOS installed and want to upgrade to v2.4, see
> the [Upgrade Instructions](#upgrading-from-ggos-23-to-24) below. Note:
...
> **⚠️ WARNING:** This script will completely replace any existing ~/ggos
> directory. Do NOT use this if you already have GGOS installed and
> configured.

Simply copy this and run it:

![GGOS First Install Command](img/first-install-cmd.jpg)
...
![GGOS Install Script Command](img/install-script.jpg)
